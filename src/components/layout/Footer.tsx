      ...
      <div className="container">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-12 py-16 border-t border-border">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2">
              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="text-sm hover:text-accent transition-colors">Instagram</a>
              ...
              <a href="https://behance.net" target="_blank" rel="noopener noreferrer" className="text-sm hover:text-accent transition-colors">Behance</a>
            </div>
          </div>
          <div className="flex flex-col gap-4">
            <h4 className="text-[10px] uppercase tracking-widest font-bold text-muted-foreground">Contact</h4>
            <div className="flex flex-col gap-2">
              <a href="mailto:hello@ant-codex.com" className="text-sm hover:text-accent transition-colors">hello@ant-codex.com</a>
              <Link href="/contact" className="text-sm hover:text-accent transition-colors">Start a Project</Link>
            </div>
          </div>
          <div className="flex flex-col gap-4">
            <h4 className="text-[10px] uppercase tracking-widest font-bold text-muted-foreground">Legal</h4>
            <div className="flex flex-col gap-2">
              <Link href="/privacy" className="text-sm hover:text-accent transition-colors">Privacy Policy</Link>
              <Link href="/terms" className="text-sm hover:text-accent transition-colors">Terms of Service</Link>
            </div>
          </div>
        </div>
